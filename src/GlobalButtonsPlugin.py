...
class GlobalButtonsPlugin(Plugin):
    def __init__(self, context):
        ...
        self.radio_pub = rospy.Publisher(
            "/from_gui", RadioMsg, queue_size=10
        )  # for sending estop commands to the robot
        self.big_red_pub = rospy.Publisher(
            "/gui/global_estop", Bool, queue_size=10
        )  # for telling the other plugins we jsut sen estop commands
