...
class DarpaBridge:
    def __init__(self, config_filename):
        ...
        self.request_info_uri = darpa_params["scoring_uris"][
            0
        ]  # uri for requesting information (time,score,etc) from darpa
    ...
    def getStatus(self):
        ...
        time_remaining = self.displaySeconds(
            float(self.darpa_status_update["run_clock"])
        )
