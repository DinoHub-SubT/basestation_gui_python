...
def make6DofMarker( fixed, interaction_mode, position, server, menu_handler, show_6dof = False):
...
if __name__=="__main__":
    ...
    menu_handler.insert( "First Entry", parent=sub_menu_handle, callback=processFeedback, args=(server) )
    menu_handler.insert( "Second Entry", parent=sub_menu_handle, callback=processFeedback, args=(server) )
  
    
    position = Point( 3, 0, 0)
    make6DofMarker( False, InteractiveMarkerControl.MOVE_3D, position, server, menu_handler, False)
